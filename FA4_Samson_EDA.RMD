...
# The plot is hollow up because the correlation between the mortality index and mean average temperature follows a U-shaped pattern. The mortality index initially decreases as the mean average temperature increases but then rises again. This implies a non-linear relationship in which the mortality index is affected by the mean average temperature in a not monotonic manner. This U-shaped pattern suggests that particular temperature ranges may be associated with lower mortality rates, whereas others may be associated with higher mortality rates.
